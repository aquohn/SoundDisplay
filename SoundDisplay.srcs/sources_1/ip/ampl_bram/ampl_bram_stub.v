...
module ampl_bram(clka, wea, addra, dina, clkb, addrb, doutb)
/* synthesis syn_black_box black_box_pad_pin="clka,wea[0:0],addra[9:0],dina[12:0],clkb,addrb[9:0],doutb[12:0]" */;
  input clka;
  input [0:0]wea;
  input [9:0]addra;
  input [12:0]dina;
